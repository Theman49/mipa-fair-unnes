...
<body>
    ...
    <div class="content">
        ...
        <nav id="navbar" class="full-container navbar navbar-expand-lg navbar-dark">
            <div class="container-fluid">
                <a class="navbar-brand" href="#"><img src="./image/logo 1.png" alt="" width="189"></a>
                ...
                <div class="collapse navbar-collapse text-center" id="navbarNavDropdown">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                        <a id="nav-beranda" class="nav-link active" aria-current="page" href="index.html">Beranda</a>
                        </li>
                        <li class="nav-item">
                        <a id="nav-sambutan" class="nav-link" href="#sambutan" onclick="goTo()">Sambutan</a>
                        </li>
                        <li class="nav-item">
                        <a id="nav-ukm" class="nav-link" href="ukm.html" onclick="goTo3()">UKM</a>
                        </li>
                    </ul>
                    <ul class="navbar-nav">
                        <li>
                            <a id="liveNow" href="#teaser" class="btn btn-danger button__live " onclick="goTo2()">Live Now</a>
                        </li>
                    </ul>
                </div>
        ...
        <div id="teaser" class="section">
            <section class="teaser row">
                ...
                <iframe width="100%" src="https://www.youtube.com/embed/H1kOuGP3Ce4?rel=0" title="YouTube video player" frameborder="1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </section>
        </div>
        ...
        <div id="sponsor-n-medpart" class="section">
            ...
            <section class="medpart row mt-5">
                ...
                <div class="container py-5">
                    ...
                    {
                    ?>
                        <img src="https://drive.google.com/uc?export=view&id=1lS8S9ugeE2cHtK3JtHTZhBsYhjqiVPFf" alt="" height="100">
                        <img src="https://drive.google.com/uc?export=view&id=1BJHQ9TLjC-hgvR5gfVhWjmWLiUkcszVW" alt="" height="100">
                    <?php 
                    }
                    ?>
                </div>
